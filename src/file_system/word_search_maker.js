...
<div id="content">
    <div class="hide-on-print">
        comma separated word list. Group letters by putting them between < >:
        <div>
        ...
        <div id="hw-inputs">
            <div>
                ...
                advanced: <input type="checkbox" id="advanced" checked></input>
            </div>
            <div>
            ...
            <div>
                ...
                show solutions: <input type="checkbox" id="show-solutions" onchange="showSolutions()"></input>
            </div>
        </div>
...
<script>
    ...
    const showSolutions = () => {
        if(wordSearchData.draw) wordSearchData.draw();
    };
    ...
    const generate = () => {
        ...
        wordSearchData.draw = function (){
            ...
            this.forEach(row => {
                row.forEach(l => {
                    if(document.getElementById("show-solutions").checked && !l.canChange){
                        ctx.fillStyle = "red";
                    }
        ...
        document.getElementById("words-display").innerHTML = "<div>word list: </div><table>" + trows + "</table>";
